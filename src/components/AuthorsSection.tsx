...
const AuthorsSection = () => {
  return (
    <section id="authors" className="px-6 py-20 md:px-20 md:py-28" style={{ background: "#0D1117" }}>
      <div className="max-w-[1080px] mx-auto stagger-children">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          ...
          <div className="glass-card p-10 scroll-reveal">
            ...
            />
            <h3 className="font-display font-bold text-white mt-6" style={{ fontSize: 28 }}>Adam Fridman</h3>
            ...
            <p className="font-sans mt-4" style={{ fontSize: 14, lineHeight: 1.78, color: "rgba(255,255,255,0.55)" }}>
            ...
            <div className="flex flex-wrap gap-2 mt-5">
              {["Author · The Science of Story", "500 Interviews", "100+ Podcast Episodes", "12 Years, Mabbly"].map((c) => (
                <span
                  ...
                  style={{ fontSize: 8, padding: "5px 14px", border: "1px solid rgba(255,255,255,0.12)", color: "rgba(255,255,255,0.5)" }}
                >
                  {c}
                </span>
              ))}
          ...
          <div className="glass-card p-10 scroll-reveal">
            <img
              ...
              style={{ border: "3px solid rgba(184,147,58,0.3)" }}
            />
            <h3 className="font-display font-bold text-white mt-6" style={{ fontSize: 28 }}>Richard Ashbaugh</h3>
            <p className="font-mono uppercase text-gold mt-1.5" style={{ fontSize: 10, letterSpacing: "0.14em" }}>
